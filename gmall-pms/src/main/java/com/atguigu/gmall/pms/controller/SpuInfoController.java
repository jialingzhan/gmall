...
public class SpuInfoController {
    ...
    @GetMapping
    public Resp<PageVo> queryByCatId(QueryCondition condition, @RequestParam(value = "catId",defaultValue = "0")Long catId){
        PageVo page = spuInfoService.queryByCatId(condition,catId);
        return Resp.ok(page);
    }
